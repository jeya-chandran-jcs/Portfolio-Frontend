    ...
    <div className="py-5 ">
      <div  className="container-fluid home-container">
        ...
        <Row className="align-items-center">
          ...
          <p data-aos="fade-right">Hello! I'm Jeya Chandran S, an MSc Computer Science graduate who recently completed a
            ...
            <hr />
            <p data-aos="fade-right">I adapt well to any work environment, whether a fast-paced startup or a 
            ...
            <hr />
            <p data-aos="fade-right">I believe in the power of teamwork and enjoy collaborating to achieve common goals.
            ...
            <hr />
            <p data-aos="fade-right">If you're looking for a dedicated developer to bring your ideas to life,
